...
class OphCiPrimaryactivationModule extends BaseEventTypeModule
{
	...
	public function init() {
		...
		$this->setImport(array(
			'OphCiPrimaryactivation.models.*',
			'OphCiPrimaryactivation.components.*',
		));
		
		$this->moduleShortSuffix = "primaryactivation";
	}
